...
# Google Maps API (for map integration in trip details)
...
To enable map functionality in trip details:
...
2. **Add API Key to Environment**
   - Add `VITE_GOOGLE_MAPS_API_KEY=your-api-key` to your `.env` file
   - The map will show a fallback message if no API key is provided
